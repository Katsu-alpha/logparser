#
#   dif-client-table-xls.py
#
#   show ap debug client-table の出力を解析し、各クライアントの時系列のリトライ率を Excel 形式で出力
#
...
parser = argparse.ArgumentParser(description="Parse show ap debug client-table outputs and generate Retry Rate history to Excel")
...
#
#   generate per-client retry rate history
#
macs = sorted(macs)
tbl = []
